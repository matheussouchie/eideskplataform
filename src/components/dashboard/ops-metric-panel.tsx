        ...
        {rows.length ? (
          rows.map((row) => (
            ...
            >
              ...
              <span className="rounded-full bg-white px-3 py-1 text-sm font-semibold text-slate-900 ring-1 ring-slate-200 dark:bg-slate-950 dark:text-white dark:ring-slate-700">
                {row.total}
              </span>
            </div>
          ))
