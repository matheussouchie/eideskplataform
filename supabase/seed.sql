...
insert into public.workspace_memberships (workspace_id, user_id, domain_id, role, created_at)
select
  '10000000-0000-0000-0000-000000000001',
...
set team_id = (
  ...
  when '00000000-0000-0000-0000-000000000007' then '12000000-0000-0000-0000-000000000001'
  else null
  end
)::uuid
where id in (
