...
('00000000-0000-0000-0000-000000000001', 'Camila Duarte', null, timezone('utc', now()) - interval '20 days', timezone('utc', now()) - interval '1 day'),
('00000000-0000-0000-0000-000000000002', 'Lucas Martins', null, timezone('utc', now()) - interval '19 days', timezone('utc', now()) - interval '2 days'),
('00000000-0000-0000-0000-000000000003', 'Bianca Ribeiro', null, timezone('utc', now()) - interval '18 days', timezone('utc', now()) - interval '3 days'),
('00000000-0000-0000-0000-000000000004', 'Rafael Gomes', null, timezone('utc', now()) - interval '17 days', timezone('utc', now()) - interval '4 days'),
('00000000-0000-0000-0000-000000000005', 'Julia Ferraz', null, timezone('utc', now()) - interval '16 days', timezone('utc', now()) - interval '6 days'),
('00000000-0000-0000-0000-000000000006', 'Marcos Leal', null, timezone('utc', now()) - interval '15 days', timezone('utc', now()) - interval '5 days')
...
insert into public.workspaces (id, name, slug, created_by, created_at, updated_at) values
('10000000-0000-0000-0000-000000000001', 'EiDesk Operacoes Demo', 'eidesk-operacoes-demo', '00000000-0000-0000-0000-000000000001', timezone('utc', now()) - interval '14 days', timezone('utc', now()) - interval '1 day');

insert into public.workspace_memberships (workspace_id, user_id, role, created_at) values
('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'admin', timezone('utc', now()) - interval '14 days'),
('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002', 'agent', timezone('utc', now()) - interval '14 days'),
('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003', 'agent', timezone('utc', now()) - interval '13 days'),
('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000004', 'agent', timezone('utc', now()) - interval '13 days'),
...
('30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000005', 'Abri o chamado apos testar em duas maquinas diferentes e o comportamento foi o mesmo.', false, timezone('utc', now()) - interval '10 days' + interval '20 minutes'),
('30000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002', 'Recebi o caso e estou verificando o fluxo de redirecionamento apos autenticacao.', false, timezone('utc', now()) - interval '9 days' + interval '1 hour'),
('30000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000006', 'Testei com PDF e imagem. A falha acontece apenas com arquivos maiores.', false, timezone('utc', now()) - interval '9 days' + interval '35 minutes'),
('30000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003', 'Consegui reproduzir. Vou ajustar a validacao do upload e retorno aqui com o teste.', false, timezone('utc', now()) - interval '8 days' + interval '2 hours'),
('30000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000005', 'Precisamos desse acesso antes de segunda-feira para nao sobrecarregar a equipe atual.', false, timezone('utc', now()) - interval '8 days' + interval '10 minutes'),
('30000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000004', 'Cadastro solicitado foi provisionado e o novo agente ja consegue acessar o ambiente.', false, timezone('utc', now()) - interval '2 days' + interval '50 minutes'),
('30000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000006', 'No Edge eu fico com a tela em branco logo apos abrir a fila de tickets.', false, timezone('utc', now()) - interval '8 days' + interval '15 minutes'),
('30000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002', 'Aplicamos uma correcao de compatibilidade e agora a lista voltou a renderizar normalmente no Edge.', false, timezone('utc', now()) - interval '1 day' + interval '1 hour'),
('30000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000005', 'Testamos com tres usuarios novos hoje de manha e nenhum recebeu o email de redefinicao.', false, timezone('utc', now()) - interval '7 days' + interval '25 minutes'),
('30000000-0000-0000-0000-000000000010', '20000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000003', 'Estou analisando a configuracao do provedor de email e confirmando se houve bloqueio por reputacao.', false, timezone('utc', now()) - interval '6 days' + interval '1 hour'),
('30000000-0000-0000-0000-000000000011', '20000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000006', 'Em telas menores o botao de envio fica parcialmente escondido abaixo da dobra.', false, timezone('utc', now()) - interval '6 days' + interval '30 minutes'),
('30000000-0000-0000-0000-000000000012', '20000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000004', 'Ajustei o layout responsivo em homologacao. Se estiver ok no seu aparelho, encerramos o caso.', false, timezone('utc', now()) - interval '1 day' + interval '40 minutes'),
('30000000-0000-0000-0000-000000000013', '20000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000005', 'Hoje a equipe precisa abrir cada ticket para entender a prioridade, o que atrasa o atendimento.', false, timezone('utc', now()) - interval '5 days' + interval '15 minutes'),
('30000000-0000-0000-0000-000000000014', '20000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Sugestao recebida. Vamos manter na fila de melhorias para a proxima sprint funcional.', false, timezone('utc', now()) - interval '4 days' + interval '2 hours'),
('30000000-0000-0000-0000-000000000015', '20000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000006', 'Recebi duas copias do mesmo email ao responder o ticket 874.', false, timezone('utc', now()) - interval '4 days' + interval '45 minutes'),
('30000000-0000-0000-0000-000000000016', '20000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000002', 'A duplicidade foi reproduzida e a regra de disparo foi corrigida. Pode validar novamente, por favor?', false, timezone('utc', now()) - interval '12 hours'),
('30000000-0000-0000-0000-000000000017', '20000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000005', 'Mesmo com papel de administracao, o formulario abre bloqueado para edicao.', false, timezone('utc', now()) - interval '3 days' + interval '20 minutes'),
